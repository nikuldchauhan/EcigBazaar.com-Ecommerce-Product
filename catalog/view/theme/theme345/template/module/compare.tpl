	...
	<div class="box-content">
		...
		<div class="compare-block compare-block_<?php echo $product['product_id']; ?> clearfix">
			...
			<div class="extra-wrap">
				...
				<div class="remove">
					<a alt="<?php echo $button_remove; ?>" title="<?php echo $button_remove; ?>" class="hide_compare" onclick="RemoveCompare(<?php echo $product['product_id']; ?>)" ><i class="fa fa-times-circle" ></i></a>
				</div>
			</div>
		</div>
		<?php } ?>
