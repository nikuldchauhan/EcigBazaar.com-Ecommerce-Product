...
<link rel="stylesheet" href="<?=$base_url;?>/sites/all/themes/cigbazar/css/doc.css" type="text/css" media="screen" /> 
<link rel="stylesheet" href="<?=$base_url;?>/sites/all/themes/cigbazar/css/flexslider.css" type="text/css" media="screen" /> 
<script type="text/javascript" src="<?=$base_url;?>/sites/all/themes/cigbazar/js/jquery-1.4.min.js"></script>
<script type="text/javascript" src="<?=$base_url;?>/sites/all/themes/cigbazar/js/jquery.carousel.min.js"></script>
...
<script>window.jQuery || document.write('<script src=""<?=$base_url;?>/sites/all/themes/cigbazar/js/jquery-1.7.min.js">\x3C/script>')</script>
<!-- FlexSlider -->
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js"></script>
<script src="<?=$base_url;?>/sites/all/themes/cigbazar/js/modernizr.js"></script>
<script defer src="<?=$base_url;?>/sites/all/themes/cigbazar/js/jquery.flexslider.js"></script>
...
?>
      ...
      <div id="center"><div id="squeeze"><div class="right-corner"><div class="left-corner">
        ...
        <div class="flexslider">
          <ul class="slides">
           <li> <a href="products"><img border="0" alt="" src="<?=$base_url;?>/sites/all/themes/cigbazar/images/banner1.jpg" /></a></li>
            <li><a href="products"><img border="0" alt="" src="<?=$base_url;?>/sites/all/themes/cigbazar/images/banner2.jpg" /></a></li>
        </ul>
        </div>
        </div>
